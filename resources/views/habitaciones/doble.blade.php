...
@section('meta')
  ...
  <meta property="og:image" content="{{ asset('images/habitacion21/habitacion21-20.jpg') }}" />
  ...
  <meta name="twitter:image" content="{{ asset('images/habitacion21/habitacion21-20.jpg') }}" />
...
@section('content')
  @include('habitaciones._detail', [
    ...
    'mainImg' => 'images/habitacion21/habitacion21-20.jpg',
