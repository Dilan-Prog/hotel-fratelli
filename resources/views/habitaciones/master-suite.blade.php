...
@section('meta')
  ...
  <meta property="og:image" content="{{ asset('images/Habitación22/Habitacion22-1.jpg') }}" />
  ...
  <meta name="twitter:image" content="{{ asset('images/Habitación22/Habitacion22-1.jpg') }}" />
...
@section('content')
  @include('habitaciones._detail', [
    ...
    'mainImg' => 'images/Habitación22/Habitacion22-1.jpg',
    'thumbs' => ['images/Habitación22/Habitacion22-25.jpg', 'images/Habitación22/Habitacion22-15.jpg', 'images/Habitación22/Habitacion22-8.jpg'],
