...
@section('meta')
  ...
  <meta property="og:image" content="{{ asset('images/habitacion19/habitacion19-35.jpg') }}" />
  ...
  <meta name="twitter:image" content="{{ asset('images/habitacion19/habitacion19-35.jpg') }}" />
  ...
  <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Habitación Cuádruple — Hotel Fratelli Aguascalientes",
  "description": "Para 4 personas, 2 camas matrimoniales. La opción con más espacio para familias o grupos grandes.",
  "image": "{{ asset('images/habitacion19/habitacion19-35.jpg') }}",
  "brand": { "@type": "Brand", "name": "Hotel Fratelli" },
  "offers": {
    "@type": "Offer",
    "url": "https://hotelfratelli.com.mx/habitaciones/cuadruple",
    "priceCurrency": "MXN",
    "price": "1606.50",
...
@section('content')
  @include('habitaciones._detail', [
    ...
    'mainImg' => 'images/habitacion19/habitacion19-35.jpg',
