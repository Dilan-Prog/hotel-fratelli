...
@section('meta')
  ...
  <meta property="og:image" content="{{ asset('images/habitacion24/habitacion24-22.jpg') }}" />
  ...
  <meta name="twitter:image" content="{{ asset('images/habitacion24/habitacion24-22.jpg') }}" />
...
@section('content')
  @include('habitaciones._detail', [
    ...
    'mainImg' => 'images/habitacion24/habitacion24-22.jpg',
    'thumbs' => ['images/habitacion24/habitacion24-2.jpg', 'images/habitacion24/habitacion24-8.jpg', 'images/habitacion24/habitacion24-15.jpg'],
