...
@section('content')
        ...
        <div class="container hero-inner">
            ...
            <div class="hero-cta">
                <a href="{{ route('habitaciones.index') }}" class="btn btn-gold" title="Ver habitaciones">Ver
                    habitaciones</a>
                <a href="https://wa.me/524492196201" class="btn btn-outline" title="Contactar por WhatsApp" target="_blank"
                    rel="noopener">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                        <path
                            d="M17.5 14.4c-.3-.1-1.7-.8-1.9-.9-.3-.1-.5-.1-.7.1-.2.3-.8.9-.9 1.1-.2.2-.3.2-.6.1-.3-.1-1.2-.4-2.3-1.4-.8-.8-1.4-1.7-1.6-2-.2-.3 0-.5.1-.6.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2 0-.4 0-.5 0-.1-.7-1.6-.9-2.2-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.5.1-.8.4-.3.3-1 1-1 2.4 0 1.4 1 2.8 1.2 3 .1.2 2 3 4.8 4.2 1.7.7 2.3.8 3.1.7.5-.1 1.7-.7 1.9-1.4.2-.7.2-1.2.2-1.4-.1-.1-.3-.2-.6-.3zM12 2C6.5 2 2 6.5 2 12c0 1.8.5 3.5 1.3 5L2 22l5.2-1.3c1.4.8 3 1.2 4.8 1.2 5.5 0 10-4.5 10-10S17.5 2 12 2z" />
                    </svg>
    ...
    <section class="why" id="porque" aria-labelledby="why-title">
        <div class="container">
            <div class="section-head reveal">
                ...
                <p class="section-sub">Cuatro razones por las que nuestros huéspedes regresan a Hotel Fratelli cada vez que
                    visitan Aguascalientes.</p>
            </div>
            <div class="why-split">
                ...
                <div class="why-list">
                    <div class="why-card reveal">
                        <div class="why-icon" aria-hidden="true"><svg width="22" height="22" viewBox="0 0 24 24"
                    ...
                    <div class="why-card reveal">
                        <div class="why-icon" aria-hidden="true"><svg width="22" height="22" viewBox="0 0 24 24"
                                ...
                                <path d="M8.5 15a8 8 0 017 0" />
                                <circle cx="12" cy="18" r="1" fill="currentColor" />
                            </svg></div>
                        <div>
                            <h3>WiFi gratis en todo el hotel</h3>
                            <p>Conexión de alta velocidad en habitaciones, lobby y balcón. Trabaja o conéctate con los
                                tuyos.</p>
                        </div>
                    </div>
                    <div class="why-card reveal">
                        ...
                        <div>
                            ...
                            <p>Calidad boutique con tarifas honestas: desde MXN $714.00 la noche con todo lo esencial
                                incluido.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="rooms" id="habitaciones" aria-labelledby="rooms-title">
        <div class="container">
            <div class="section-head reveal">
                ...
                <p class="section-sub">Cuatro categorías diseñadas para cada tipo de viajero: trabajo, pareja, familia o
                    estancias largas.</p>
            </div>
                ...
                <div class="reveal">
                    ...
                    <div class="location-meta">
                        ...
                        <div class="loc-row">
                            ...
                            <div><strong>15 minutos</strong><span class="muted">del Aeropuerto Internacional de
                                    Aguascalientes</span></div>
                        </div>
                        <div class="loc-row">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="1.6" aria-hidden="true">
                            ...
                            <div><strong>Centro Histórico</strong><span class="muted">a 10 minutos en auto · plaza Patria
                                    y catedral</span></div>
                        </div>
                    </div>
                ...
                <div class="carousel-track" tabindex="0">
                    ...
                    <article class="carousel-card review">
                            ...
                            <p class="review-text">Vine por trabajo y terminé recomendándolo a todo el equipo. La relación
                                ...
                                Volveré en mi próxima visita a Aguascalientes.</p>
                            <div class="reviewer">
                                <div class="avatar" aria-hidden="true">JC</div>
                                <div class="reviewer-info">
                                    <div class="name">Jorge Cervantes</div>
                                    <div class="date">Hace 1 mes</div>
                                </div>
                                <div class="review-source">Google</div>
                            </div>
                    </article>
                    ...
                    <article class="carousel-card review">
                            ...
                            <div class="reviewer">
                                ...
                                <div class="reviewer-info">
                                    <div class="name">Andrea López</div>
                                    <div class="date">Hace 3 meses</div>
                                </div>
                    ...
                    <article class="carousel-card review">
                            ...
                            <div class="reviewer">
                                <div class="avatar" aria-hidden="true">RD</div>
                                <div class="reviewer-info">
                                    <div class="name">Ricardo Dávila</div>
                                    <div class="date">Hace 1 mes</div>
                                </div>
                                <div class="review-source">Google</div>
                            </div>
                    ...
                    <article class="carousel-card review">
                            ...
                            <p class="review-text">Lo mejor: la atención. Desde el check-in nos sentimos en familia.
                                ...
                                olvidaremos. Súper recomendado.</p>
                            <div class="reviewer">
                                <div class="avatar" aria-hidden="true">SP</div>
                                <div class="reviewer-info">
                                    <div class="name">Sofía Padilla</div>
                                    <div class="date">Hace 2 meses</div>
                                </div>
                                <div class="review-source">Booking</div>
                            </div>
                    </article>
                    ...
                    <article class="carousel-card review">
                            ...
                            <div class="reviewer">
                                ...
                                <div class="reviewer-info">
                                    <div class="name">Eduardo Martínez</div>
                                    <div class="date">Hace 4 meses</div>
                                </div>
                                <div class="review-source">Google</div>
                            </div>
                    </article>
                    ...
                    <article class="carousel-card review">
                            ...
                            <div class="reviewer">
                                <div class="avatar" aria-hidden="true">LH</div>
                                <div class="reviewer-info">
                                    <div class="name">Lucía Hernández</div>
                                    <div class="date">Hace 5 meses</div>
                                </div>
                                <div class="review-source">Booking</div>
                            </div>
                    </article>
                    ...
                    <article class="carousel-card review">
                            ...
                            <p class="review-text">Estancia de negocios de 4 noches. Habitación silenciosa, escritorio
                                ...
                                quieres complicarte.</p>
                            <div class="reviewer">
                                <div class="avatar" aria-hidden="true">FG</div>
                                <div class="reviewer-info">
                                    <div class="name">Fernando García</div>
                                    <div class="date">Hace 6 meses</div>
                                </div>
                                <div class="review-source">Google</div>
                            </div>
                    </article>
                    ...
                    <article class="carousel-card review">
                            ...
                            <div class="reviewer">
                                ...
                                <div class="reviewer-info">
                                    <div class="name">Carolina Reyes</div>
                                    <div class="date">Hace 7 meses</div>
                                </div>
                                <div class="review-source">Google</div>
                            </div>
                    </article>
                    ...
                    <article class="carousel-card review">
                            ...
                            <div class="reviewer">
                                ...
                                <div class="reviewer-info">
                                    <div class="name">Paola Vargas</div>
                                    <div class="date">Hace 8 meses</div>
                                </div>
                                <div class="review-source">Booking</div>
                            </div>
                    </article>
        ...
        <div class="container">
            ...
            <div class="contact-grid">
                ...
                <aside class="contact-info reveal" aria-label="Información de contacto">
                    <div class="info-row">
                        <div class="info-icon" aria-hidden="true"><svg width="20" height="20"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
                                <path
                                    d="M22 16.92V21a1 1 0 01-1.1 1A19 19 0 012 4.1 1 1 0 013 3h4.09a1 1 0 011 .75l1 4a1 1 0 01-.27 1L7 10.5a16 16 0 006.5 6.5l1.75-1.82a1 1 0 011-.27l4 1a1 1 0 01.75 1z" />
                            </svg></div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-content">
                            ...
                            <div class="value"><a href="mailto:fratelli.hotel@gmail.com">fratelli.hotel@gmail.com</a>
                            </div>
                        </div>
                    </div>
                    <div class="info-row">
                        ...
                        <div class="info-content">
                            ...
                            <div class="value">República de Brasil 627<br />Fracc. Las Américas · Aguascalientes</div>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="info-icon" aria-hidden="true"><svg width="20" height="20"
                        ...
                        <div class="info-content">
                            ...
                            <div class="value">Recepción 24 horas · Check-in 14:00 · Check-out 12:00</div>
                        </div>
                    </div>
                </aside>
            </div>
    ...
    <section id="ciudad" aria-labelledby="ciudad-title">
        <div class="container">
            ...
            <div class="seo-prose">
                <p>Aguascalientes tiene mucho más que la Feria de San Marcos. Desde Hotel Fratelli, en Fraccionamiento Las
                    Américas, estás a un corto trayecto en auto de los puntos más visitados de la ciudad, sin el tráfico ni
                    el ruido de hospedarte justo en la zona turística.</p>
                <p>A 10 minutos tienes el Centro Histórico: Plaza de la Patria, la Catedral Basílica y el Teatro Morelos,
                    con sus fachadas del siglo XIX. Un poco más allá está el Museo Nacional de la Muerte, con una de las
                    colecciones más singulares de México sobre el tema, y el Jardín de San Marcos, corazón de la feria cada
                    primavera, que vale la pena recorrer incluso fuera de temporada.</p>
                <p>Por eso somos una opción práctica entre los hoteles en Aguascalientes: llegas, descansas y sales a
                    conocer la ciudad sin perder tiempo en trayectos largos. Ideal tanto para quien viene por la Feria como
                    para quien solo quiere conocer Aguascalientes con calma.</p>
            </div>
        </div>
    </section>
    ...
    <section id="faq" aria-labelledby="faq-title">
        <div class="container">
            ...
            <div class="faq-list">
                ...
                {{-- EXISTENTE 1 — sin link (no aplica redirección) --}}
                <div class="faq-item reveal">
                    <h3>¿A qué hora es el check-in y el check-out?</h3>
                    <p>El check-in es a partir de las 14:00 horas y el check-out hasta las 12:00 horas. Nuestra recepción
                        está disponible las 24 horas, así que si llegas antes o necesitas salir más tarde, escríbenos y con
                        gusto revisamos disponibilidad.</p>
                </div>
                ...
                <div class="faq-item reveal">
                    ...
                    <p>Reserva por <a href="https://wa.me/524492196201" class="link-text-seo-redirect" target="_blank"
                            rel="noopener noreferrer" title="Reservar por WhatsApp">WhatsApp</a>, teléfono o el formulario
                        de esta página. Al reservar directo con nosotros no pagas comisiones de plataformas externas,
                        obtienes la mejor tarifa disponible y confirmación en menos de 2 horas.</p>
                </div>
                ...
                <div class="faq-item reveal">
                    ...
                    <p>Sí. Hotel Fratelli ofrece tarifas desde MXN $714.00 la noche con WiFi gratuito y recepción 24 horas
                        incluidos. Somos una de las opciones de <a href="#"
                            class="link-text-seo-redirect" title="Hoteles económicos en Aguascalientes">hoteles económicos
                            en Aguascalientes</a> con mejor relación calidad-precio de la ciudad.</p>
                </div>

                {{-- NUEVA 2 — keyword parcial: precios --}}
                <div class="faq-item reveal">
                    <h3>¿Cuáles son los precios de los hoteles en Aguascalientes?</h3>
                    <p>En Hotel Fratelli los precios van desde MXN $714.00 por noche en habitación sencilla hasta MXN
                        $952.00 en Máster Suite. Puedes consultar todas las tarifas y disponibilidad en nuestra <a
                            href="{{ route('habitaciones.index') }}" class="link-text-seo-redirect"
                            title="Ver precios y habitaciones Hotel Fratelli">página de habitaciones</a>.</p>
                </div>

                {{-- NUEVA 3 — keyword parcial: aeropuerto --}}
                <div class="faq-item reveal">
                    <h3>¿Están cerca del aeropuerto de Aguascalientes?</h3>
                    <p>Hotel Fratelli se encuentra a solo 15 minutos del Aeropuerto Internacional de Aguascalientes en auto.
                        También estamos a 5 minutos de la Feria de San Marcos y a 10 minutos del Centro Histórico. Consulta
                        cómo llegar en nuestra <a href="#ubicacion" class="link-text-seo-redirect"
