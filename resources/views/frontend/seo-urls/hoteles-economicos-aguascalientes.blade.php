...
@section('title', 'Hoteles Económicos en Aguascalientes | Hotel Fratelli desde $714.00/noche')
...
@section('meta')
  ...
  <meta name="twitter:title" content="Hoteles Económicos en Aguascalientes | Hotel Fratelli desde $714.00/noche" />
...
@section('content')
  <header class="hero hero-medium">
    <div class="hero-bg" aria-hidden="true"><img src="{{ asset('images/habitacion17/habitacion17-16.jpg') }}" alt="Habitación sencilla, Hoteles económicos en Aguascalientes — Hotel Fratelli" /></div>
    <div class="container hero-inner">
      <span class="hero-eyebrow">Desde MXN $714.00 / noche</span>
  ...
  <section>
    <div class="container">
      ...
      <div class="feature-strip" style="grid-template-columns: repeat(3, 1fr);">
      ...
      <div class="seo-prose">
        ...
        <h3>Habitación Sencilla — desde $714.00 MXN</h3>
        ...
        <h3>Habitación Doble — desde $833.00 MXN</h3>
        <p>Cama matrimonial o camas separadas según prefieras. Ideal para amigos, familia compacta o compañeros de viaje que comparten cuarto.</p>

        <h3>Suite Jr — desde $892.50 MXN</h3>
        ...
        <ul>
          ...
          <li><strong>Acceso a balcón con vistas a la ciudad.</strong></li>
        </ul>
